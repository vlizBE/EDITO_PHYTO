...
*Store this file in your workspace and open it in Rstudio to have an interactive document.*
...
We start from describing the input data, Rscripts and functions that were used for this Nutrient-Phytoplankton-Zooplankton-Detritus (NPZD) model. Then, this manual will guide you step by step on how to run the NPZD model. At the end, phyto- and zooplankton dynamics will be simulated and the relative contributions of the environmental parameters estimated.
...
![](~/work/EDITO_PHYTO/NPZD/npzd.jpg)
...
![](~/work/EDITO_PHYTO/NPZD/map BPNS.png)
...
current_folder_input_data <- "~/work/EDITO_PHYTO/NPZD/Input data"
current_folder_Rscripts <- "~/work/EDITO_PHYTO/NPZD/Rscripts"
...
dir.create("~/work/NPZD/Output/Final results/NPZD") # create an subfolderfolder for your final NPZD results
...
```
Now, there should be a folder called 'NPZ' in your workspace, containing the subfolder 'Input data','Rscripts' and 'Output'. These subfolders contain subfolders and data or Rscripts. Having these files in our workspace, makes it possible to run the NPZD model.
