...
```
Now, there should be a folder called 'NPZ' in your workspace, containing the subfolder 'Input data','Rscripts' and 'Output'. These subfolder contain subfolders and data or Rscripts. Having these files in our workspace, makes it possible to run the NPZD model.
